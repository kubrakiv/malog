...
# Deployment script for malog application on Linux server (PRODUCTION)
...
APP_ROOT=/home/kubrakiv/malog/malog-app
...
# Optional: prompt for version (e.g. v1.2.0)
...
echo ""
echo "=============================================="
echo "✅ Production TMS deployment complete!"
echo "=============================================="
echo ""
